  ...
  return (
    <>
      {render ? (
        <Productdetail
          chat={propsdata.chat}
          check={propsdata.check}
          content={propsdata.content}
          data={propsdata.data}
          heart={propsdata.heart}
          imgsrc={propsdata.imgsrc}
          location={propsdata.location}
          nickname={propsdata.nickname}
          price={propsdata.price}
          profileImage={propsdata.profileImage}
          recommend={propsdata.recommend}
          side={propsdata.side}
          state={myBoard}
    ...
    <Main>
      <Section>
        ...
        >
          <SwiperPhoto
            ...
            imgsrc={
              imgsrc[0] !== undefined
                ? imgsrc
                : "https://firebasestorage.googleapis.com/v0/b/patato-market.appspot.com/o/no_image.jpg?alt=media&token=d2d005ba-9dbb-40cb-bd61-4d47f5118b2c"
            }
          />
        </button>
        ...
        <div className="article">
          ...
          <p className="price">{moneyUnit(price)}원</p>
      ...
      <Section>
        ...
        <div className="best-product">
          {render ? (
            recommendCount.map((
              { content, title, price, side, imgsrc, location, id, heart, check, recommend }, index ) => (
                <Product
                  key={index}
                  check={check}
                  content={content}
          ...
          <form>
            ...
            <div className="input-wrapper">
              <WriteInput
                ...
                name="modifiedTitle"
                type="text"
                value={modifiedContent.modifiedTitle}
              ...
              <WriteInput
                ...
                name="modifiedPrice"
                type="number"
                value={modifiedContent.modifiedPrice}
                onChange={onChangeHandler}
              />
            </div>
            <WriteInput
              ...
              type="text"
              value={modifiedContent.modifiedContent}
              onChange={onChangeHandler}
            />
            <div className="button-wrapper">              
              <CustomButton
                className="modifie-button"
                onClick={() => {
                  const newObj = {
